                        ...
                        {course.instructors.map((v) => (
                            <div className="single-course-page-main-instructors-data-container">
                                ...
                                <div className="single-course-page-main-instructors-data-container-head">
                                    ...
                                    <span>
                                        <div><StarIcon /> {v.rating} rating</div>
                                        <div><WorkspacePremiumIcon /> {v.reviews} reviews</div>
                                        <div><GroupIcon /> {v.students} students</div>
                                        <div><PlayCircleIcon /> {v.courses} courses</div>
                                    </span>
                                </div>
